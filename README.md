...
The larger boxes being the stems and the smaller boxes being the buds. As I did this, I logged the amount of buds and stems in an excel spreadsheet which I later used to analyze the data: [Saguaro Bud Counts - Sheet1.csv](Saguaro Bud Counts - Sheet1.csv). 
## Analyzing Data
## Machine Learning
